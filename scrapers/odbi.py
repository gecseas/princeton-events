...
URL: https://bioengineering.princeton.edu/events
Structure: Princeton Drupal theme, same pattern as CBE/CEE/ECE etc.
"""
...
def scrape() -> list[dict]:
    ...
    rows = soup.select(".view-content .views-row, .views-row, article, .event")
    events = []
